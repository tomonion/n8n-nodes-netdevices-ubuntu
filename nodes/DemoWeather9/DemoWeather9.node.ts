...
export class DemoWeather9 implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'Demo Weather 9',
        name: 'demoWeather9',
        icon: 'file:weather-icon.svg',
        group: ['transform'],
        version: [1, 0, 0],
        ...
        properties: [
...

			{
				...
				description: 'The zip code of the location to return the weather of. Format: zip code, country code (e.g. 10115,de).',
			},
			{
...
async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    const credentials = await this.getCredentials('demoWeather9Api');
